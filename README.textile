...
* The "Google Chart API":http://code.google.com/apis/chart/ is used to create charts that provide a visual representation of the relative staleness of each site. 